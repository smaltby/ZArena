...
import net.minecraft.server.v1_5_R3.BlockTrapdoor;
...
public class ZTollSign extends ZSign implements Externalizable
{
	...
	public boolean executeClick(Player player)
	{
		...
		net.minecraft.server.v1_5_R3.Block nmsBlock = net.minecraft.server.v1_5_R3.Block.byId[costBlock.getType().getId()];
		net.minecraft.server.v1_5_R3.World nmsWorld = ((CraftWorld) costBlock.getWorld()).getHandle();
