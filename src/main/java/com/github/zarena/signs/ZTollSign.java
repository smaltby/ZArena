...
import net.minecraft.server.v1_6_R1.BlockDoor;
import net.minecraft.server.v1_6_R1.BlockTrapdoor;
...
public class ZTollSign extends ZSign implements Externalizable
{
	...
	public boolean executeClick(Player player)
	{
		...
		net.minecraft.server.v1_6_R1.Block nmsBlock = net.minecraft.server.v1_6_R1.Block.byId[costBlock.getType().getId()];
		net.minecraft.server.v1_6_R1.World nmsWorld = ((CraftWorld) costBlock.getWorld()).getHandle();
