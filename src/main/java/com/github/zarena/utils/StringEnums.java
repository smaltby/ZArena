...
public enum StringEnums
{
	...
	// Used in ZACommands
	ENTER, JOIN, LEAVE, RELOAD, STATS, VOTE, /*LIST,*/ NEW, CREATE, /*DELETE,*/ /*REMOVE,*/ SAVE, LOAD, GAMEMODE, ALIVE, SETALIVE, SETSESSION,
	SETLEAVELOCATION, SETLEAVELOC, OPTIONS, SESSION, START, STOP, SETWAVE, INFO, /*WAVE,*/ DIA, DIAGNOSTIC,
